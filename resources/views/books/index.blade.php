...
<form method="GET" action="{{route('books.index')}}" class="mb-4 flex items-center space-x-2">
     <input type="text" name="title" placeholder="Search by title" value="{{old('title')}}" class="input h-10">
...
<div class="filter-container mb-4 flex">
    @php
        $filters=[
            ...
            // 'highest_rated_last_month'=>'Highsest Rated Last Month',
    ...
    @forelse ($books as $book )
        <li class="mb-4">
          ...
          <div class="flex flex-wrap items-center justify-between">
            ...
            <div>
                <div class="book-rating">{{number_format($book->reviews_avg_rating)}}</div>
